...
public class JobDTO {
	...
	public void setModality(String modality) {
		String val = modality == null ? null : modality.replaceAll("\\t", " ").replaceAll("\\n", "; ").replaceAll("\\r", "; ").replaceAll(",", ";");
		
		this.modality = val == null ? null : (val.length() <= 200 ? val : val.substring(0, 200));
	}
	/**
	...
	public void setSubModality(String subModality) {
		String val = subModality == null ? null : subModality.replaceAll("\\t", " ").replaceAll("\\n", "; ").replaceAll("\\r", "; ").replaceAll(",", ";");
		
		this.subModality = val == null ? null : (val.length() <= 200 ? val : val.substring(0, 200));
	}
	/**
	 * @return the hotJob
	 */
	...
	public String getDescription() {
		//System.out.println("returning from get description: " + description);
		return description;
	}
	/**
	...
	public void setDescription(String description) {
		...
		//System.out.println("returning from set description: " + this.description);
